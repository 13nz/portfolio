            ...
            <RevealOnScroll>
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/*  music visualizer */}
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-purple-400/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)]">
                            <img src={musicVisImg} alt="Space Beagle Screenshot" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        {/*  weather stats */}
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-purple-400/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)]">
                        <img src={weatherDataImg} alt="Space Beagle Screenshot" className="w-full h-48 object-cover rounded-lg mb-4" />
                        ...
                        {/*  Snooker */}
                        <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-purple-400/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)]">
                        <img src={snookerImg} alt="Space Beagle Screenshot" className="w-full h-48 object-cover rounded-lg mb-4" />
